...
class DirectBase(ABC):
    ...
    def __init__(self, problem,
        ...
        if self.debug:
            ...
            logging.basicConfig(
                # filename = '/home/fu/workspace/DIRECT_reachability/empirical_analysis/new_1/3d7.log',
                # filemode = 'w',
                format='[%(asctime)s] - %(message)s',
                datefmt='%Y/%m/%d %H:%M:%S',
                level=logging.INFO)
    ...
    def _query_func_val(self, centers):
        ...
        points = []
        for c in centers:
            # print(self._to_actual_point(c, self.lb, self.space_length))
...
class LowBoundedDIRECT_full_parrallel(LowBoundedDIRECT):
    def _divide_space(self):
        dims_dict = {}
        all_new_points = []
...
if __name__ == "__main__":
    ...
    # print(solver.rcd.local_slope.max())
    ...
    # solver = LowBoundedDIRECT_full_parrallel(demo_problem, 2, b, max_deep=20, max_feval=4000, tolerance=1e-1, max_iter=100, debug=False)
